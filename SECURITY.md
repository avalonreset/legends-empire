...
Use GitHub [private vulnerability reporting](https://github.com/avalonreset/legends-obsidian/security/advisories/new)
for this Legends distribution. For issues in the unchanged engine, coordinate a private report with the upstream project as appropriate. If that form is unavailable, contact the
