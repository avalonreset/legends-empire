# Contributing to Legends Obsidian

Legends packaging and host-integration contributions belong at https://github.com/avalonreset/legends-obsidian. The knowledge engine comes from [Daniel Agrici's claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian); discuss generally useful engine changes upstream. Preserve its license, attribution, and parity boundary.
