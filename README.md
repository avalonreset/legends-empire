...
<h1 align="center">legends-obsidian</h1>
...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/release-v2.3.0-d97745" alt="Release v2.3.0"></a>
</p>
...
legends-obsidian is a local-first knowledge system for Claude Code and compatible
...
## Public Legends distribution

This distribution extends [AgriciDaniel/claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian) under MIT; upstream notices are preserved. Download the audited ZIP from [Releases](https://github.com/avalonreset/legends-obsidian/releases), extract it, and run `python scripts/claude-obsidian.py --help`. No pip installation is required. Read `skills/legends-obsidian/SKILL.md` as the portable entry point. Native Windows supports inspection and dry runs; transactional vault writes require WSL or a supported POSIX host.

Research handoff: [DataForSEO and GeoGrid evidence recipe](docs/RESEARCH-EVIDENCE-HANDOFF.md). This recipe does not automatically approve or ingest untrusted research.
