...
Legends Obsidian is a provider-neutral distribution of Daniel Agrici's local-first Agent Skills package for building source-cited,
...
Say **Legends Obsidian** to users. Keep internal `claude_obsidian` identifiers for compatibility. Credit [Daniel Agrici](https://github.com/AgriciDaniel/claude-obsidian) as the upstream creator.
...
The 15 upstream skills plus one neutral routing skill live at `skills/<name>/SKILL.md`. They use the portable Agent
