# Legends Obsidian changelog

## [2.1.1] - 2026-09-05

Initial provider-neutral Legends distribution of Daniel Agrici's claude-obsidian. Preserves upstream v2.1.1 plus main `ad67087` recovery/response hardening, all 15 canonical skills, and the original MIT license. Adds a neutral router/CLI, four-host installation, parity verification, and distribution documentation.

Also fixes upstream Windows ZIP auditing by opening archives in binary mode,
with regression tests for CRLF and Ctrl-Z bytes.
